 ...
 * so if we setup a log level using <code>TALog.init(...)</code>, all the logs which is with
...
public class LogLevel {
  ...
  /**
   * Log level for TALog.v.
   */
  public static final int VERBOSE = 2;

  /**
   * Log level for TALog.d.
   */
  public static final int DEBUG = 3;

  /**
   * Log level for TALog.i.
   */
  public static final int INFO = 4;

  /**
   * Log level for TALog.w.
   */
  public static final int WARN = 5;

  /**
   * Log level for TALog.e.
   */
  public static final int ERROR = 6;

  /**
   * Log level for TALog#init, printing all logs.
   */
  public static final int ALL = Integer.MIN_VALUE;

  /**
   * Log level for TALog#init, printing no log.
   */
